...
public class UpdateTeaView extends JFrame {
	/**
	 * 
	 */
	...
	private Teacher tea;
	public UpdateTeaView(Teacher tea) throws HeadlessException {
		super();
	...
	public void init()
	{
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					JOptionPane.showMessageDialog(UpdateTeaView.this, "名字不能为空!");
				}
				else if(phone.getText().equals(""))
				{
					JOptionPane.showMessageDialog(UpdateTeaView.this, "电话不能为空!");
				}
				else if(address.getText().equals(""))
				{
					JOptionPane.showMessageDialog(UpdateTeaView.this, "地址不能为空!");
				}
				else 
				{
					//教工号自增
					...
					if(teaDao.UpdateTeacher(tea)){
						JOptionPane.showMessageDialog(UpdateTeaView.this, "修改成功!");
						dispose();
					}else {
						JOptionPane.showMessageDialog(UpdateTeaView.this, "修改失败!");
					}
				}
