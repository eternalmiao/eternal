...
public class StuChangePswView extends JFrame {
	/**
	 * 
	 */
	...
	public StuChangePswView(Student stu) throws HeadlessException {
		super();
	...
	private void initListener() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (old.equals("")) {
					JOptionPane.showMessageDialog(StuChangePswView.this,
							"旧密码不能为空!");
				} else if (!old.equals(stu.getPassword())) {
					JOptionPane
							.showMessageDialog(StuChangePswView.this, "旧密码不正确!");
				} else if (newp.equals("")) {
					JOptionPane.showMessageDialog(StuChangePswView.this,
							"新密码不能为空!");
				} else if (sure.equals("")) {
					...
					JOptionPane.showMessageDialog(StuChangePswView.this, "密码不一致!");
				} else {

					// 学生修改
					stu.setPassword(newp);
					if (stubiz.changePsw(stu)) {
						JOptionPane.showMessageDialog(StuChangePswView.this,
								"修改成功!");
						dispose();
					} else {
