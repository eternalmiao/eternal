...
public class AddStuView extends JFrame {
	...
	public AddStuView() throws HeadlessException {
		super();
		...
		btnok.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (name.getText().equals("")) {
					JOptionPane.showMessageDialog(AddStuView.this, "名字不能为空!");
				} else if (phone.getText().equals("")) {
					JOptionPane.showMessageDialog(AddStuView.this, "电话不能为空!");
				} else if (address.getText().equals("")) {
					JOptionPane.showMessageDialog(AddStuView.this, "地址不能为空!");
				} else if (dormitory.getText().equals("")) {
					JOptionPane.showMessageDialog(AddStuView.this, "宿舍号不能为空!");
				} else {
					// 学号自增长，不可改
					// 添加修改方法
					...
					Student stu = new Student(0, stuname, stuphone, "000000", stuaddress, studormitory, major, grade, classno);
					if(stuDao.addStudent(stu)){
						JOptionPane.showMessageDialog(AddStuView.this,
								"添加成功!");
						dispose();
					}else {
						JOptionPane.showMessageDialog(AddStuView.this,
