	...
	<body>
		...
		<div id="content">
			...
			<div class="m-right">
				...
				<div class="main">
							<form action="MgrChangePsw.do" method="post">
								原密码：<input type="password" id="oldpsw" onblur="checkpsw()"><label id="tips"></label>
								<br />
								<br />
								<label id="newpsw" hidden="true">新密码：<input type="password"   name="newpsw" ></label>
								<br />
								<br />
								<input type="submit" value="确定修改" id="btn" hidden="true">
							</form>
